...
const LogIn = () => {
  ...
  return (
    <div>
        ...
        <button onClick={() => setModalOpen(true)} className="btn btn-active btn-primary text-white mr-auto">LogIn</button>
        {/* Modal component */}
                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">Login to your account</h1>
                            ...
                            <form className="space-y-4 md:space-y-6" action="#">
                                ...
                                {/* LogIn button */}
                                <button type="submit" className="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 btn btn-active btn-primary">LogIn</button>
                                {/* Sign up link */}
