...
const SignUp = () => {
  ...
  return (
    <div>
        ...
        <button onClick={() => setModalOpen(true)} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign Up</button>
        {/* Modal component */}
                    ...
                    <form className="space-y-6" action="#" method="POST">
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-3 text-sm">
                                <label htmlFor="remember" className="text-black">I Agree to <span className='text-indigo-600 hover:text-indigo-500'>the Privacy Policy</span></label>
                            </div>
                        </div>
